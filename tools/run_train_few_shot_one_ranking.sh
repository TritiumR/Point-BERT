...
do
  bash ./scripts/train_BERT.sh 1 \
    ...
    --offline_data_dir ./confidence_data/gt_data-train_fixed_cam_new_new_ruler_data-pushing \
    --additional_data_dir ./confidence_data/gt_data-train_fixed_cam_train_data-pushing \
